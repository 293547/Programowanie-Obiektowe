...
public:
    ...
    void inputList() {
        ...
        for (int i = 0; i < studentAddAmount; i++) {
            ...
            /* TODO: Kompilator wywala blad "class Person has no member named setIndex".
              Zakomentowane zeby reszta dzialala.
    ...
    void printList() {
        cout << "\nNr | Indeks | Imie | Nazwisko | Ob. 1 | Ob. 2\n";
        cout << "---------------------------------------------------\n";
        for (int i = 0; i < N; i++) {
            if (students[i] != nullptr) {
    ...
    void editStudent() {
        ...
        if (foundIndex != -1) {
            ...
            if (subChoice == 1) {
                ...
                cout << "Funkcja tymczasowo zablokowana\n";
            } else if (subChoice == 3) {
