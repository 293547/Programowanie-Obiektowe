...
public:
    ...
    void inputList() {
        ...
        for (int i = 0; i < studentAddAmount; i++) {
            ...
            while (true) {
                ...
                cin >> inputData;
                if (((Student*)students[idx])->setIndex(inputData) == 0) break;
    ...
    void printList() {
        ...
        for (int i = 0; i < N; i++) {
            if (students[i] != nullptr) {
                cout << i + 1 << ") " << ((Student*)students[i])->getIndex() << " | " 
    ...
    void editStudent() {
        ...
        if (foundIndex != -1) {
            ...
            if (subChoice == 1) {
                ...
                cout << "Nowy indeks: "; 
                cin >> inputData;
                if(((Student*)students[foundIndex])->setIndex(inputData) == -1) cout << "Blad walidacji!\n";
                else cout << "Dane zaktualizowane\n";
            } else if (subChoice == 3) {
